...
# REMOVIDOS -F dir=+ e -F obj=/opt/CrowdStrike/falcon-sensor - por erros de sintaxe/campo
-a always,exit -F arch=b32 -S connect -F key=crowdstrike_network
-a always,exit -F arch=b64 -S connect -F key=crowdstrike_network
